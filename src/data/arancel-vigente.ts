// ⚠️ GENERADO AUTOMÁTICAMENTE — no lo edites a mano.
//
...
// Actualizado: 2026-08-20T11:10:30.502Z

/** Solicitud de registro de marca nueva, por clase (100 UMAPI) */
export const ARANCEL_MARCA_NUEVA = 39735;

/** Mes del valor UMAPI con el que se calculó ese arancel */
export const ARANCEL_VIGENCIA = 'agosto 2026';

/** Valor de 1 UMAPI, en pesos */
export const UMAPI = 397.35;
